package Todo.example.TodoAnnotation.controller;

import Todo.example.TodoAnnotation.entity.Todo;
...
public class TodoController {
    ...
    @PostMapping("todo")
    public String addTodos(@RequestBody Todo todo) {
